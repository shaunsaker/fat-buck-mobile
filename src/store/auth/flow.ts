...
export function* onInitiateSignInFlow(
...
export function* watchInitiateSignInFlow(): SagaIterator {
  yield takeLatest(AuthActionTypes.INITIATE_SIGN_IN, onInitiateSignInFlow);
}

export const SIGN_IN_SUCCESS_MESSAGE = 'Sign in success.';

export function* onSignInFlow(action: ActionType<typeof signIn>): SagaIterator {
...
export function* watchSignInFlow(): SagaIterator {
  yield takeLatest(AuthActionTypes.SIGN_IN, onSignInFlow);
}

export const SIGN_OUT_SUCCESS_MESSAGE = 'Sign out success.';

export function* onSignOutFlow(): SagaIterator {
  try {
...
export function* watchSignOutFlow(): SagaIterator {
  yield takeLatest(AuthActionTypes.SIGN_OUT, onSignOutFlow);
}

export const PASSWORD_RESET_SUCCESS_MESSAGE =
  'Password reset link sent successfully.';

export function* onSendPasswordResetEmailFlow(
...
export function* watchSendPasswordResetEmailFlow(): SagaIterator {
  yield takeLatest(
    AuthActionTypes.SEND_PASSWORD_RESET_EMAIL,
...
export function* authFlow(): SagaIterator {
  ...
  yield fork(watchSendPasswordResetEmailFlow);
}
